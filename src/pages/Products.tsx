...
const BASE_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "spare",
    categoryName: "قطع الغيار والخدمات",
    description: "تصنيع وتوريد أقماع تفريغ مصممة هندسياً بانسيابية عالية لتوجيه وسكب الخرسانة والركام بدقة، مبطنة ومصنعة من صلب مقاوم للتآكل والاحتكاك الشديد لمنع الالتصاق وضمان تدفق سلس وسريع.",
    image: "/images/قمع_تفريغ.webp",
    specs: ["تصميم هندسي ثلاثي الأبعاد عالي الانسيابية", "سبائك صلب معالجة ومقاومة للاحتكاك والتآكل", "فتحات تفريغ سفلية محكمة التوصيل", "متوفر بجميع المقاسات والسعات لمختلف الخلاطات"]
  },
  {
    id: 23,
    title: "استيل استراكشن",
    category: "batching",
    categoryName: "محطات خرسانة وهياكل",
    description: "تصنيع وتجهيز هياكل معدنية واستيل استراكشن (Steel Structures) لمحطات الخرسانة الجاهزة والمستودعات وخطوط الإنتاج بأعلى معايير المتانة الهندسية ودقة التصنيع والتجميع الموقعي.",
    image: "/images/استيل_استراكشن.webp",
    specs: ["تصميم وتصنيع قطاعات صلب ثقيلة", "تجميع ونقل موقعي سريع ودقيق", "دهانات حماية ومعالجة ضد الصدأ والتآكل", "مطابقة للمواصفات الهندسية الإنشائية"]
  },
  {
    id: 24,
    title: "هزاز كهرباء بكل المقاسات",
    category: "spare",
    categoryName: "قطع الغيار والخدمات",
    description: "محركات وهزازات كهربائية صناعية متطورة (Vibrator Motors) لمهزات الركام، وقواديس الفيدر، وصوامع الإسمنت بمختلف المقاسات والقدرات لضمان انسيابية تدفق المواد ومنع الانسداد.",
    image: "/images/هزاز_كهرباء.webp",
    specs: ["متوفر بجميع القدرات والمقاسات", "محركات كهربائية معزولة IP66 فائقة الكفاءة", "قوة اهتزاز عالية وتحمل شاق", "متوافق مع الصوامع والمهزات والفيدر بوكس"]
  },
  {
    id: 25,
    title: "كاوتشه قمع تفريغ",
    category: "spare",
    categoryName: "قطع الغيار والخدمات",
    description: "جلب وبطانات كاوتش أصلية لأقماع تفريغ محطات وخلاطات الخرسانة، مصنعة من مطاط صناعي فائق المرونة والمقاومة للتآكل والاحتكاك الشديد لمنع تناثر الخرسانة وتسهيل التفريغ.",
    image: "/images/كاوتشة_قمع_تفريغ.webp",
    specs: ["خامات مطاطية عالية المرونة والمتانة", "مقاومة شديدة للاحتكاك والتآكل الميكانيكي", "أقطار ومقاسات تناسب جميع الأقماع والخلاطات", "سهولة التركيب والاستبدال الفوري"]
  },
  {
    id: 26,
    title: "واير ليس لسيفر و 2 رمود للتحكم عن بعد",
    category: "spare",
    categoryName: "قطع الغيار والخدمات",
    description: "أنظمة تحكم لاسلكية صناعية متطورة (Wireless Receiver + 2 Remotes) للتحكم عن بعد في بوابات وسيور ومحطات الخرسانة والرافعات مع مدى إشارة بعيد وأمان تشغيلي عالي ومفاتيح طوارئ.",
    image: "/images/وايرليس_تحكم_عن_بعد.webp",
    specs: ["ريسيفر استقبال صناعي + 2 ريموت كنترول", "مدى إرسال لاسلكي قوي ومقاوم للتداخل", "أزرار تحكم معزولة ومفاتيح إيقاف طوارئ", "سهل التوصيل والبرمجة مع لوحات الكنترول"]
  },
  {
    id: 27,
    title: "عجل سير متحرك",
    category: "spare",
    categoryName: "قطع الغيار والخدمات",
    description: "عجلات وطنابير حركة لسيور النقل المتحركة ومحطات الخرسانة المقطورة، مكسوة بطبقات بولي يوريثان عالية الصلابة والتحمل ومزودة برولمانات بلي شاقة ومحاور صلب معالجة.",
    image: "/images/عجل_سير_متحرك.webp",
    specs: ["عجلات صلب مكسوة بولي يوريثان عالي التحمل", "محاور دوران مصقولة ورولمانات بلي معزولة", "مقاومة عالية للأحمال الثقيلة والصدمات", "سهولة الحركة والمناورة في مواقع العمل"]
  },
  {
    id: 2,
